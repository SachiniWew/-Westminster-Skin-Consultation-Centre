...
public class Doctor extends Person{
    ...
    public void setSpecialisation(int specialisationNum) {
        this.specialisation = Specialisation.Dry_skin.getSpecialisationOfNumber(specialisationNum);
    }
    ...
    static void setDoctorSpecializationNumber(Doctor doctor, BufferedReader reader){
        System.out.println("-------------------------------------------------------------------");
        System.out.println("                            Specialized in                         ");
        System.out.println("-------------------------------------------------------------------");
        ...
        while (true){
            try {
                ...
                System.err.println("-------------------------------------------------------------------");
                System.err.println("            Integer format expected  between 1 to 19               ");
                System.err.println("-------------------------------------------------------------------");
