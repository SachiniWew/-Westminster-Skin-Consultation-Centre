...
public interface SkinConsultationManager {
    ...
    void saveInDoctorFile() throws IOException;
    static void readDoctorFile() throws IOException{
        ...
        while(true){
            ...
            switch (i % 8) {
                ...
                case 3 -> mobileNumber = line.split(":")[1].trim();
                case 4 -> dateOfBirth = line.split(":")[1].trim();
                case 5 -> address = line.split(":")[1].trim();
                case 6 -> specialisation = Integer.parseInt(line.split(":")[1].trim());
                case 0 -> {
