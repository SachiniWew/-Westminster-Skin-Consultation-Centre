...
public class Person {
    ...
    public void setMobileNumber(String mobileNumber) {
        if (mobileNumber.length()!=10 || !mobileNumber.matches("[0-9]+")) throw new NumberFormatException("Enter Phone Number");
    ...
    public static String[] setFullName(BufferedReader reader) throws IOException {
        ...
        do {
            firstNameTemp = readingNull(enterYourDetails("                    Enter first name                            :", reader));
            surNameTemp = readingNull(enterYourDetails  ("                    Enter surname                               :", reader));
            if (firstNameTemp == null || surNameTemp == null) System.err.println("                        Can't be null                            ");
        ...
        try {
            while (true){
                try {
                    ...
                    mobileNumber = enterYourDetails("                    Enter mobile number                         :", reader);
                    if (mobileNumber.length()!=10 || !mobileNumber.matches("[0-9]+")) throw new NumberFormatException();
                    break;
                } catch (NumberFormatException e) {
                    System.out.println("\n");
                    System.out.println("-------------------------------------------------------------------");
                    System.out.println(" The mobile phone number should contain 10 digits. Please Reenter  ");
                    System.out.println("-------------------------------------------------------------------");
                }
            }


            address =readingNull(enterYourDetails("                    Enter address                               :", reader));

            while (true){
                try {
                    DOB = enterYourDetails("                    Enter Date Of Birth (YYYY-MM-DD)            :", reader);
                    ...
                    System.out.println("\n");
                    System.out.println("--------------------------------------------------------------");
                    System.out.println("     Date of birth should be YYYY-MM-DD pattern and Valid     ");
                    System.out.println("--------------------------------------------------------------");
                }
            }
